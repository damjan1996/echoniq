...
def create_project_structure():
    ...
    files = [
        ...
        "src/pages/artists/components/index.tsx",
        "src/pages/artists/components/Filters.tsx",
        "src/pages/artists/[slug]/index.tsx",
